...
1. C-04 Add UI diff viewer screen in Next.js for visual diff results.
2. D-04 Connect deploy workflow to provider secrets + real deploy commands.
3. D-05 Add environment-specific provider auth + IAM setup docs.
