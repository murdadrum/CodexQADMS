...
1. D-03 Add Terraform infra skeleton directories.
2. C-04 Add UI diff viewer screen in Next.js for visual diff results.
3. D-04 Connect deploy workflow to provider secrets + real deploy commands.
