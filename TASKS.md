...
1. B-05 Build violations list UI (filter by severity/category).
2. B-06 Build violation detail panel (evidence + fix hint).
3. B-07 Add report export endpoint (`report.json`).
