...
| D-06 | Add container build pipeline for API/web images | done | codex | P1 | D-04 | Images built and pushed from CI/CD |
| D-07 | Add container build cache/attestations for supply chain | todo | codex | P2 | D-06 | Build provenance and cache reuse enabled |
...
3. D-07 Add container build cache/attestations for supply chain.
